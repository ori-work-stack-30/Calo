...
export default function AIChatScreen() {
  ...
  const texts = {
    ...
    allergenWarning: t("ai_chat.allergen_warning") || (language === "he" ? "אזהרת אלרגן!" : "Allergen Warning!"),
    clearChat: t("ai_chat.clear_history"),
    tryThese: t("ai_chat.try_these") || (language === "he" ? "נסה את אלה:" : "Try these:"),
    welcomeMessage:
    ...
    networkError:
      t("ai_chat.network_error"),
    loadingProfile:
      t("ai_chat.loading_profile") || (language === "he" ? "טוען פרופיל משתמש..." : "Loading user profile..."),
  };
