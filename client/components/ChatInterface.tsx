...
export default function ChatInterface({ children }: ChatInterfaceProps) {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      text: t("ai_chat.welcome_message") || 'שלום! אני כאן לעזור לך לבחור מה לאכול. ספר לי על ההעדפות שלך, הדיאטה שלך, או פשוט שאל אותי מה מומלץ לאכול עכשיו! 🍽️',
      isUser: false,
      timestamp: new Date(),
      suggestions: [
    ...
    <View style={dynamicStyles.container}>
      ...
      >
        ...
        >
          ...
          <Text style={[dynamicStyles.swipeIndicatorText, isRTL && dynamicStyles.rtlText]}>
          ...
          >
            <SafeAreaView style={dynamicStyles.chatSafeArea}>
              ...
              <View style={dynamicStyles.chatHeader}>
                ...
                >
                  <View style={[dynamicStyles.chatHeaderLeft, isRTL && dynamicStyles.rtlRow]}>
                    ...
                    <View style={[dynamicStyles.chatHeaderTextContainer, isRTL && dynamicStyles.rtlAlign]}>
                      <Text style={[dynamicStyles.chatTitle, { color: colors.text }, isRTL && dynamicStyles.rtlText]}>
                        {t("ai_chat.title")}
                      </Text>
                      <Text style={[dynamicStyles.chatSubtitle, { color: colors.textSecondary }, isRTL && dynamicStyles.rtlText]}>
              ...
              >
                {messages.map((message) => (
                  <View key={message.id} style={dynamicStyles.messageWrapper}>
                    <View style={[
                      ...
                      isRTL && (message.isUser ? dynamicStyles.userMessageRTL : dynamicStyles.botMessageRTL)
                    ]}>
                      {!message.isUser && (
                        <View style={dynamicStyles.botIconContainer}>
                          <Sparkles size={16} color={colors.emerald600} strokeWidth={2} />
                        </View>
                      )}
                      <Text style={[
                        dynamicStyles.messageText,
                        message.isUser ? dynamicStyles.userMessageText : dynamicStyles.botMessageText,
                      ...
                      <Text style={[
                        ...
                        message.isUser ? dynamicStyles.userMessageTime : dynamicStyles.botMessageTime,
                        isRTL && dynamicStyles.rtlText
                      ]}>
                    ...
                    {message.suggestions && (
                      <View style={[dynamicStyles.suggestionsContainer, isRTL && dynamicStyles.suggestionsContainerRTL]}>
                ...
                {isTyping && (
                  <View style={[dynamicStyles.typingContainer, isRTL && dynamicStyles.typingContainerRTL]}>
                    <View style={dynamicStyles.typingBubble}>
                      <View style={dynamicStyles.typingDots}>
                        <Animated.View style={[dynamicStyles.typingDot, { backgroundColor: colors.emerald500 }]} />
                        <Animated.View style={[dynamicStyles.typingDot, { backgroundColor: colors.emerald500 }]} />
                        <Animated.View style={[dynamicStyles.typingDot, { backgroundColor: colors.emerald500 }]} />
                      </View>
                    </View>
              ...
              >
                ...
                >
                  <View style={[dynamicStyles.inputWrapper, isRTL && dynamicStyles.inputWrapperRTL]}>
                    <TextInput
                      style={[
                      ...
                      placeholder={t("ai_chat.type_message") || "שאל אותי מה לאכול..."}
                    ...
                    <TouchableOpacity
                      style={[
                        ...
                        (!inputText.trim() || isTyping) && dynamicStyles.sendButtonDisabled
                      ]}
                  ...
                  <View style={[dynamicStyles.quickActions, isRTL && dynamicStyles.quickActionsRTL]}>
                    <TouchableOpacity 
                      style={dynamicStyles.quickAction}
                      onPress={() => sendMessage(t("ai_chat.suggestion_breakfast") || 'מה מומלץ לארוחת בוקר?')}
                    >
                      <Coffee size={16} color={colors.emerald600} strokeWidth={2} />
                      <Text style={[dynamicStyles.quickActionText, { color: colors.emerald600 }, isRTL && dynamicStyles.rtlText]}>
                        {t("ai_chat.breakfast") || "ארוחת בוקר"}
                      </Text>
                    </TouchableOpacity>
                    <TouchableOpacity 
                      style={dynamicStyles.quickAction}
                      onPress={() => sendMessage(t("ai_chat.suggestion_quick") || 'משהו מהיר להכנה')}
                    >
                      <Clock size={16} color={colors.emerald600} strokeWidth={2} />
                      <Text style={[dynamicStyles.quickActionText, { color: colors.emerald600 }, isRTL && dynamicStyles.rtlText]}>
                    ...
                    <TouchableOpacity 
                      style={dynamicStyles.quickAction}
                      onPress={() => sendMessage(t("ai_chat.suggestion_healthy") || 'משהו בריא ומזין')}
                    >
                      <Heart size={16} color={colors.emerald600} strokeWidth={2} />
                      <Text style={[dynamicStyles.quickActionText, { color: colors.emerald600 }, isRTL && dynamicStyles.rtlText]}>
                    ...
                    <TouchableOpacity 
                      style={dynamicStyles.quickAction}
                      onPress={() => sendMessage(t("ai_chat.suggestion_snacks") || 'רעיונות לחטיפים')}
                    >
                      <Apple size={16} color={colors.emerald600} strokeWidth={2} />
                      <Text style={[dynamicStyles.quickActionText, { color: colors.emerald600 }, isRTL && dynamicStyles.rtlText]}>
