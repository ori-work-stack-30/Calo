...
export default function FloatingChatButton() {
  ...
  const [snapSide, setSnapSide] = useState<"left" | "right">(isRTL ? "left" : "right");
  ...
  return (
    <>
      ...
      >
        ...
        {/* Side indicator */}
        <View style={[
          dynamicStyles.sideIndicator,
          { [snapSide]: -8 }
        ]}>
          <View style={[dynamicStyles.indicatorDot, { backgroundColor: colors.emerald500 }]} />
        </View>
      </Animated.View>
        ...
        <SafeAreaView style={dynamicStyles.modalContainer}>
          ...
          <View style={dynamicStyles.header}>
            ...
            >
              ...
              <View style={[dynamicStyles.headerTitle, isRTL && dynamicStyles.rtlRow]}>
                ...
                <View style={[dynamicStyles.headerTextContainer, isRTL && dynamicStyles.rtlAlign]}>
                  <Text style={[dynamicStyles.headerTitleText, { color: colors.text }, isRTL && dynamicStyles.rtlText]}>
                    {t("tabs.ai_chat")}
                  </Text>
                  <Text style={[dynamicStyles.headerSubtitle, { color: colors.textSecondary }, isRTL && dynamicStyles.rtlText]}>
